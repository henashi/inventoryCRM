    ...
    <a-card class="table-card">
      ...
      >
        ...
        <template #action="{ record }">
          <a-button type="link" size="small" @click="handleDataDictEdit(record)"> 编辑 </a-button>
          <a-button
            type="link"
            @click="handleActiveOrDisable(record, true)"
            v-if="record.status === 'DICT_STATUS_ACTIVE'"
          >
            失效
          </a-button>
          <a-button
            type="link"
            @click="handleActiveOrDisable(record, false)"
            v-if="record.status === 'DICT_STATUS_PAUSED'"
          >
            生效
          </a-button>
